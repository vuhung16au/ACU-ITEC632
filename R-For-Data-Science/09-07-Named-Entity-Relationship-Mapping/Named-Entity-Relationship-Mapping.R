...
setwd("/Users/vuhung/00.Work/02.ACU/github/ITEC632/R-For-Data-Science/09-07-Named-Entity-Relationship-Mapping")
...
# =============================================================================
# NAMED ENTITY RECOGNITION USING UDPIPE
# =============================================================================
...
ggsave("images/01_entity_type_distribution.png", p1, width = 10, height = 6, dpi = 300)

# 2. Top Entities by Frequency
...
ggsave("images/02_top_entities_frequency.png", p2, width = 12, height = 8, dpi = 300)
...
ggsave("images/03_relationship_type_distribution.png", p3, width = 10, height = 6, dpi = 300)

# 4. Entity Network Visualization
if (nrow(combined_relationships) > 0) {
  ...
  if (nrow(network_data) > 0) {
    ...
    ggsave("images/04_entity_relationship_network.png", p4, width = 12, height = 8, dpi = 300)
  }
}

# 5. Word Cloud of Entities
if (nrow(combined_entities) > 0) {
  ...
  if (nrow(entity_freq) > 0) {
    png("images/05_entity_wordcloud.png", width = 800, height = 600, bg = "white")
    wordcloud(
...
ggsave("images/06_entities_per_article.png", p6, width = 10, height = 6, dpi = 300)
...
cat("\n=== ANALYSIS COMPLETE ===\n")
cat("Visualizations saved to 'images/' directory\n")
cat("Results include entity extraction, relationship mapping, and network analysis\n")
